...
HD_PWD='/home/lorsi/FPGA/bcd_counter_behavioral/synth/bcd_counter_fpga.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log bcd_counter_behavioral_VIO.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source bcd_counter_behavioral_VIO.tcl -notrace
