...
HD_PWD='/home/lorsi/FPGA/bcd_counter_behavioral/synth/bcd_counter_fpga.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log bcd_counter_behavioral_VIO.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source bcd_counter_behavioral_VIO.tcl
